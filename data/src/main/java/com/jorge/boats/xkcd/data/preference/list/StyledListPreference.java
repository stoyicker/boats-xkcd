...
public class StyledListPreference extends ListPreference {
  ...
  private class StyledListPreferenceAdapter extends BaseAdapter {
    ...
    @Override public CharSequence getItem(final int position) {
    ...
    @Override public View getView(final int position, final @Nullable View convertView,
    ...
    private class ViewHolder {
      ...
      @NonNull private Drawable getSelectedTintedDrawable() {
        final @DrawableRes int resId = R.drawable.ic_list_preference_selected;

        return tintDrawable(resId);
      }

      @NonNull private Drawable getUnselectedTintedDrawable() {
        final @DrawableRes int resId = R.drawable.ic_list_preference_unselected;

        return tintDrawable(resId);
      }

      @NonNull private Drawable tintDrawable(final @DrawableRes int drawableResId) {
        final Drawable ret = mResources.getDrawable(drawableResId);
